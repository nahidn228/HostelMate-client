  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 py-20">
      ...
      <div className="w-1/2 relative">
        <img className='w-4/6 min-h-full shadow-xl object-cover' src={cardImg1} alt="" />
        <img className='absolute bottom-0 h-1/2 right-12 w-3/5 shadow-xl' src={cardImg2} alt="" />
      </div>
      {/* content */}
      <div className="w-1/2 space-y-4">
        ...
        <h4 className=" text-2xl lg:text-5xl font-semibold">Welcome to HostelMate </h4>
        <div className='ml-4 lg:ml-12 text-base font-normal'>
            <p>The Hotel Luviana is the right choice for visitors who are searching for a combination of charm and a convenient position from where to explore surroundings.</p> <br />
            ...
            <button className="btn btn-outline rounded-full md:px-8 hover:bg-green-600 mt-4">Read More</button>
        </div>
