...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#142943] shadow-lg   backdrop-blur-md  sticky top-0 z-50">
      <div className="navbar shadow-sm text-white  font-semibold max-w-screen-xl mx-auto ">
        ...
        <div className="flex-none navbar-end">
          <ul className="menu menu-horizontal px-1">
            ...
            {!user && (
              <li>
                <NavLink to="/login" activeClassName="text-blue-600 font-bold">
                  Join Us
                </NavLink>
              </li>
            )}
          ...
          {user && (
            <div className="dropdown dropdown-end z-50">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-[#142943] rounded-box w-52"
              >
                <li>
                  <NavLink
