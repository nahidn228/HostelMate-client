...
const UserHome = () => {
  ...
  <div className="text-center space-y-4">
    <h2 className="text-2xl uppercase font-bold">
      <span className="text-[#D1A054]">Name:</span> {singleUser?.name || "N/A"}
    </h2>
    <h2 className="text-xl">
      <span className="text-[#D1A054]">Email:</span> {singleUser?.email || "No Email"}
    </h2>
    <h2 className="text-xl">
      <span className="text-[#D1A054]">Badge:</span> {singleUser?.badge || "None"}
    </h2>
  </div>
   {/* CTA Buttons */}
