...
const UpcomingMealAdmin = () => {
  ...
  <div className="flex gap-4 items-center justify-between mb-10">
    ...
    <div className="flex gap-3 items-center">
      ...
      <button onClick={handleReset} className="btn text-[#2B3440]" disabled={!sort}>
        Reset
      </button>
    </div>
    ...
    <button
      className="btn btn-outline text-[#D1A054] hover:bg-[#D1A054] hover:text-white"
    ...
    <dialog id="my_modal_3" className="modal modal-bottom sm:modal-middle">
      <div className="modal-box">
        ...
        <h3 className="font-bold text-lg text-[#2B3440]">Add Upcoming Meal!</h3>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {/* Submit Button */}
          <button className="btn flex gap-1 bg-[#D1A054] text-white hover:bg-[#2B3440]">
          ...
          <tr key={meal._id} className="hover:bg-[#D1A054]">
            ...
            <td>
              <button
                ...
                className="btn btn-outline text-[#2B3440] border-[#D1A054] hover:bg-[#D1A054] hover:text-white"
              >
                Publish
              </button>
            </td>
